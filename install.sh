...
function show_menu() {
	...
	echo "- Set the i3, dunst, termite, picom, rofi, and bashrc config files"
	echo "- Set the wallpaper"
	echo "- Set Firefox as the default browser"
	echo "- Set Termite as the default terminal"
	echo "- Configure the Noto Sans Emoji package"
	echo "- Configure polybar"
	echo "- Install theme icons"
	echo "- Set GTK theme, icons and cursor"
	echo "- Guide you through setting up the custom theme for Firefox"
	echo "- Remove unwanted and orphaned packages"
	echo "- Restart i3"
	echo -e "\n"
